            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <a href="{{ url('admin/page/create') }}" class="btn btn-default">Add New</a>
                        ...
                        <table class="table table-hover">
                            ...
                            @foreach( $data as $key => $d )
                                <tr style="font-style: {{ $d['status'] == 0 ? ' italic':'' }}">
                                    ...
                                    <td>{{ $d['created_at'] }}</td>
                                    <td class="no">
                                        <a href="{{ url('admin/page/'.$d['id'].'/edit') }}" title="Edit">
                                            <i class="fa fa-edit"></i>
                                        </a>

                                        <form style="display: inline" action="{{ url('admin/page/'.$d['id'])}}"
                                              method="post">
