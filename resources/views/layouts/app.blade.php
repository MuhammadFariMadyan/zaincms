...
<body>
    <div>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('thumb/'.$config->image) }}" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item has-treeview">
                            <a href="{{ url('admin') }}" class="nav-link {{ empty(Request::segment(2)) ? 'active':'' }}">
                        ...
                        <li class="nav-item has-treeview {{ Request::segment(2) == 'post' ? 'menu-open':'' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ url('admin/category/post') }}" class="nav-link">
                                        <i class="fa fa-circle-o nav-icon"></i>
                                        <p>Category</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item has-treeview">
                            <a href="{{ url('admin/page') }}" class="nav-link {{ Request::segment(2) == 'page' ? 'active':'' }}">
                        ...
                        <li class="nav-item has-treeview">
                            <a href="{{ url('admin/menu') }}" class="nav-link {{ Request::segment(2) == 'menu' ? 'active':'' }}">
                        ...
                        <li class="nav-item has-treeview">
                            <a href="{{ url('admin/slide') }}" class="nav-link {{ Request::segment(2) == 'slide' ? 'active':'' }}">
                        ...
                        <li class="nav-item has-treeview">
                            <a href="{{ url('admin/config') }}" class="nav-link {{ Request::segment(2) == 'config' ? 'active':'' }}">
        ...
        <footer class="main-footer">
            <strong>Copyright © 2018-{{ date('Y') }} <a href="https://share.web.id">Zain v1</a>.</strong> All rights reserved.
        </footer>
